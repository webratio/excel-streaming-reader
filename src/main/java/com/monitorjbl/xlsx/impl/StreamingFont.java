...
public class StreamingFont implements Font, Serializable {
   ...
   */
  public StreamingFont(CTFont font) {
      _ctFont = font;
      _index = 0;
  }

  public StreamingFont(CTFont font, int index) {
      _ctFont = font;
      _index = (short)index;
  }
  ...
  /**
   * get the indexed color value for the font References a color defined in
   * IndexedColors.
   *
  ...
  /**
   * get the color value for the font References a color defined as Standard Alpha
   * Red Green Blue color value (ARGB).
   *
   ...
   * <p>
   * For many users, the related {@link #getFontHeightInPoints()} will be more
   * helpful, as that returns font heights in the more familiar points units, eg
   * 10, 12, 14.
   * 
   ...
   * <p>
   * This will return the same font height that is shown in Excel, such as 10 or
   * 14 or 28.
   * 
  ...
  /**
   * Return the raw font height, in points, but also including fractions.
   */
  ...
  /**
   * get a boolean value that specify whether to use a strikeout horizontal line
  ...
  /**
   * set a boolean value for the boldness to use. If omitted, the default value is
   * true.
   *
   ...
   * set character-set to use.
   *
   * @param charSet the {@code FontCharset} char set
   */
  ...
  /**
   * set the name for the font (i.e. Arial). If the font doesn't exist (because it
   * isn't installed on the system), or the charset is invalid for that font, then
   * another font should be substituted. The string length for this attribute
   * shall be 0 to 31 characters. Default font name is Calibri.
   *
  ...
  /**
   * set a boolean value for the property specifying whether to use a strikeout
   * horizontal line through the text or not If omitted, the default value is
   * true.
   *
   ...
   * setting. Setting this to either subscript or superscript shall make the font
   * size smaller if a smaller font size is available.
   *
  ...
  public void setTypeOffset(short offset) {
    if (offset == Font.SS_NONE) {
      ...
      CTVerticalAlignFontProperty offsetProperty = _ctFont.sizeOfVertAlignArray() == 0 ? _ctFont.addNewVertAlign()
          : _ctFont.getVertAlignArray(0);
      switch (offset) {
      case Font.SS_NONE:
  ...
  /**
   * set the style of underlining that is used. The none style is equivalent to
   * not using underlining at all.
   *
  ...
  /**
   * set an enumeration representing the style of underlining that is used. The
   * none style is equivalent to not using underlining at all. The possible values
   * for this attribute are defined by the FontUnderline
   *
   ...
   * 
   * @param styles the {@code StreamingStylesTable} styles table
   * @return the id of the registered font
   */
  public long registerTo(StreamingStylesTable styles) {
   ...
   * looking up theme based colours and properties.
   * 
   * @param themes the {@code ThemesTable} themes table object
   */
  ...
  /**
   * get the font scheme property. is used only in StylesTable to create the
   * default instance of font
   *
   * @return FontScheme
  ...
  /**
   * Set the font family this font belongs to. A font family is a set of fonts
   * having common stroke width and serif characteristics. The font name overrides
  ...
  /**
   * set an enumeration representing the font family this font belongs to. A font
   * family is a set of fonts having common stroke width and serif
   * characteristics.
   *
  ...
  /**
   * get the index within the XSSFWorkbook (sequence within the collection of Font
   * objects)
   * 
